...
import com.app.servicio.gestionMonitoreos.domain.Persona;
...
public class PersonaServicio {
    ...
    public List<Persona> getAll(){
        System.out.println("(MONITOREOS) Recuperando todas las personas de la BD.");
    ...
    public Persona getByID(int id){
        System.out.println("(MONITOREOS) Recuperando persona con ID: " + id);
    ...
    public Persona add(Persona persona){
        System.out.println("(MONITOREOS) Insertando nueva persona.");
    ...
    public Boolean edit(Persona persona){
        System.out.println("(MONITOREOS) Editando persona con ID: " + persona.getId());
    ...
    public Boolean delete(int id){
        System.out.println("(MONITOREOS) Eliminando persona con ID: " + id);

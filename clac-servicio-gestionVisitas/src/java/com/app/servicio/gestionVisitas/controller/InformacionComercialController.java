...
import com.app.servicio.gestionVisitas.domain.InformacionComercialList;
import com.app.servicio.gestionVisitas.service.InformacionComercialServicio;
...
public class InformacionComercialController {
    ...
    @RequestMapping(value="/informacionComercialDel/{id}", method = RequestMethod.DELETE, headers="Accept=application/json, application/xml")
    private @ResponseBody String deletInformacionComercial(@PathVariable("id") int id){

...
import com.app.servicio.gestionVisitas.domain.Persona;
...
public class PersonaServicio {
    ...
    public List<Persona> getAll(){
        System.out.println("(VISITAS) Recuperando todas las personas de la BD.");
    ...
    public Persona getByID(int id){
        System.out.println("(VISITAS) Recuperando persona con ID: " + id);
    ...
    public Persona add(Persona persona){
        System.out.println("(VISITAS) Insertando nueva persona.");
    ...
    public Boolean edit(Persona persona){
        System.out.println("(VISITAS) Editando persona con ID: " + persona.getId());
    ...
    public Boolean delete(int id){
        System.out.println("(VISITAS) Eliminando persona con ID: " + id);

        ...
        <div class="container mt-4" align="center">
            <form:form modelAttribute="informacionComercialAttribute" method="POST" action="${saveUrl}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input name="archivo" type="text" readonly required="false" class="form-control" aria-describedby="emailHelp" style="width: 30%;" value="${informacionComercialAttribute.archivo}"/>
                </div>

    ...
    <body>
                    ...
                    <table class="table table-hover text-center">
                        ...
                        <tbody>
                            <c:forEach var="bienes" items="${bienesGetAll}">
                                <c:url var="editUrl" value="/updateBienes?id=${bienes.idBien}" />
                                <c:url var="deleteUrl" value="/deleteBien?id=${bienes.idBien}" />
                                <c:url var="getUrl" value="/getBien?id=${bienes.idBien}" />
                                <c:url var="descarga" value="/descarga?archivo=${bienes.archivo}" />

                                <tr>
                                    <td><c:out value="${bienes.nombreNegocio}" /></td>
                                    <td><c:out value="${bienes.nombreBien}" /></td>
                                    <td><c:out value="${bienes.cantidadBien}" /></td>
                                    <td style="display: none;"><c:out value="${bienes.archivo}" /></td>
                                    <td>
                                        ...
                                        <c:if test="${bienes.archivo.equals('no archivo') == false}">
        ...
        <div align="center">
            <c:if test="${empty bienesGetAll}" >
                No hay Bienes en la Base de Datos para este registro.
                </br>
                Puedes <strong><a href="${addUrl}">Agregar</a></strong> un Bien aquí.
            </c:if>
        </div>

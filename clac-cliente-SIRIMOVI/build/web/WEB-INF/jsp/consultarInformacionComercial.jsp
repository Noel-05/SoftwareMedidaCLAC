                    ...
                    <table class="table table-hover text-center">
                        ...
                        <tbody>
                            <c:forEach var="informacionComercial" items="${informacionComercialGetAll}">
                                ...
                                <c:url var="descarga" value="/descarga?archivo=${informacionComercial.archivo}" />
                                ...
                                <tr>
                                    ...
                                    <td style="display: none;"><c:out value="${informacionComercial.archivo}" /></td>
                                    <td>
                                        ...
                                        <c:if test="${informacionComercial.archivo.equals('no archivo') == false}">

                    ...
                    <table class="table table-hover text-center">
                        ...
                        <tbody>
                            <c:forEach var="monitoreo" items="${monitoreosGetAll}">
                                ...
                                <c:url var="deleteUrl" value="/deleteMonitoreo?id=${monitoreo.idMonitoreo}" />
                                <c:url var="getUrl" value="/getMonitoreo?id=${monitoreo.idMonitoreo}" />
                                <c:url var="descarga" value="/descarga?archivo=${monitoreo.archivo}" />
                                ...
                                <tr>
                                    ...
                                    <td><fmt:formatDate pattern="dd/MM/yyyy" value="${monitoreo.fechaRegistroMonitoreo}"/></td>
                                    <td style="display: none;"><c:out value="${monitoreo.archivo}" /></td>
                                    <td>
                                        ...
                                        <c:if test="${monitoreo.archivo.equals('no archivo') == false}">

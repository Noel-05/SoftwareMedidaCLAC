                    ...
                    <table class="table table-hover text-center">
                        ...
                        <tbody>
                            <c:forEach var="informacionfinanciera" items="${infoGetAll}">
                                ...
                                <c:url var="descarga" value="/descarga?archivo=${informacionfinanciera.archivo}" />
                                ...
                                <tr>
                                    ...
                                    <td style="display: none;"><c:out value="${informacionfinanciera.archivo}" /></td>
                                    <td>
                                        ...
                                        <c:if test="${informacionfinanciera.archivo.equals('no archivo') == false}">

...
public class PersonaServicio {
    ...
    public List<Persona> getAll(){
        System.out.println("(USUARIOS) Recuperando todas las personas de la BD.");
    ...
    public Persona getByID(int id){
        System.out.println("(USUARIOS) Recuperando persona con ID: " + id);
    ...
    public Persona add(Persona persona){
        System.out.println("(USUARIOS) Insertando nueva persona.");
    ...
    public Boolean edit(Persona persona){
        System.out.println("(USUARIOS) Editando persona con ID: " + persona.getId());
    ...
    public Boolean delete(int id){
        System.out.println("(USUARIOS) Eliminando persona con ID: " + id);
